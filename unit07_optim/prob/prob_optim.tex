...
\item Use chain rule to compute the components of the gradient $\partial J/\partial w_j$.

\item Using the previous answer to write $\nabla_w J(\wbf)$ as a matrix vector product.
